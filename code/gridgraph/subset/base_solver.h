...
namespace subset {
	...
	class BaseSolver {
		...
		public:
			BaseSolver(grid_graph &instance, std::set<coord> subset, double turn_cost=0.0, double dist_cost=0.0, std::time_t deadline=0):
				m_DIST_COST{dist_cost}, m_TURN_COST{turn_cost},  m_DEADLINE{deadline}, m_instance{instance}, m_subset{subset}, m_model{m_env} 
			{
