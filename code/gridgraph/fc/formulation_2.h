//
// Second IP formulation for full coverage cycle cover and tour in grid graphs with distance and turn costs.
	...
	namespace form2 {
		...
		class Solver: public BaseSolver {
			...
			public:
				 ...
				 */
				Solver(grid_graph &instance, double turn_cost=1, double dist_cost=0, std::time_t deadline=0);
