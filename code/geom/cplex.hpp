// This is an auxiliary file for CPLEX I have obtained from a colleague
...
namespace cpxhelper {
	...
	CPLEX_HPP_NORETURN inline void wrap_and_throw_cplex_exception(IloException& ex, const char* catching_file, const char* catching_func, unsigned catching_line) {
	...
	namespace impl {
		...
		public:
			...
			wrap(wrap&& o) : M_wrapped(o.M_wrapped) {
				o.M_wrapped = Wrapped();
			}

			wrap &operator=(wrap&& o) {
				if(&o != this) {
					P_check_destroy();
